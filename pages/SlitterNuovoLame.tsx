...
const SlitterNuovoLame: React.FC<Props> = ({ profile }) => {
    ...
    <div className="min-h-screen bg-[#cbd5e1] text-slate-900 pb-20 font-sans selection:bg-blue-200">
      ...
      <div className="bg-[#1e293b] p-4 flex justify-between items-center border-b-2 border-black/20 sticky top-0 z-[100]">
         <div className="flex items-center gap-6">
            <Link to="/lavoro/macchine" className="flex items-center gap-2 text-white/60 hover:text-white transition-colors">
               <ArrowLeft size={20} /> <span className="text-xs font-bold uppercase tracking-widest">Flotta</span>
            </Link>
         ...
         <div className="flex gap-3">
            <div className="flex flex-col items-end justify-center mr-4">
               <span className="text-[8px] font-black text-white/40 uppercase tracking-widest leading-none">Macchina</span>
               <span className="text-xs font-black text-blue-500 uppercase italic">SLITTER NUOVO</span>
            </div>
            {isOperator && (
              <button 
                onClick={() => { 
...
export default SlitterNuovoLame;
