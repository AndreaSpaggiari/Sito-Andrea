      ...
      <div className="max-w-7xl mx-auto px-4 -mt-16 relative z-20">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {subsections.map((sub, idx) => (
                <Link 
                  key={idx} 
                  to={sub.link} 
                  className="bg-slate-900/80 backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-8 group hover:bg-amber-600 transition-all duration-500 overflow-hidden relative shadow-xl"
                >
                  ...
                  <div className="w-14 h-14 bg-slate-800 rounded-2xl flex items-center justify-center text-amber-500 group-hover:bg-white group-hover:text-amber-600 transition-all mb-6 shadow-inner">
                    <sub.icon size={28} />
                  </div>
                  <h3 className="text-2xl font-black text-white uppercase italic tracking-tighter group-hover:text-white leading-none">{sub.title}</h3>
                  <p className="text-slate-500 font-bold text-[10px] uppercase tracking-widest mt-1 group-hover:text-white/70">{sub.desc}</p>
                </Link>
              ))}
              
              <div className="bg-slate-900/40 border-2 border-dashed border-white/5 rounded-[2.5rem] p-8 flex flex-col items-center justify-center text-slate-600 text-center">
            ...
            <div className="bg-slate-900/80 backdrop-blur-xl rounded-[3rem] p-10 border border-white/5 shadow-2xl relative overflow-hidden">
               ...
               <p className="text-slate-400 text-sm leading-relaxed max-w-xl font-medium">Benvenuto nella tua postazione di controllo digitale. Da qui puoi monitorare le schede di produzione, i flussi di lavoro e comunicare con il team in tempo reale.</p>
               <div className="mt-8 flex gap-3">
                  <div className="bg-slate-950/50 rounded-2xl p-4 flex-1 border border-white/5">
                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Stato Sistemi</p>
                    <p className="text-xs font-bold text-emerald-500 mt-1 uppercase flex items-center gap-1.5">
                  ...
                  <div className="bg-slate-950/50 rounded-2xl p-4 flex-1 border border-white/5">
                    ...
                    <p className="text-xs font-bold text-amber-500 mt-1 uppercase tracking-tight">Supabase SQL</p>
                  </div>
               </div>
            </div>
          </div>
